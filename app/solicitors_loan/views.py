    ...
    def get_queryset(self):
        ...
        if stat is not None:
            if stat == 'active':
                ...
                # ALSO include loans that are marked paid_out but have no paid_out_date
                queryset = queryset.filter(
                    ...
                    Q(  # ✅ Add this: loans marked as paid out but no actual paid_out_date
                        approved=True,
                        loan__isnull=False,
                        loan__is_paid_out=True,
